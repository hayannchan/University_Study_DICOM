...
#define DCM_DICT_DEFAULT_PATH "/usr/local/share/dcmtk-3.6.7-DEV/dicom.dic"
...
#define DEFAULT_CONFIGURATION_DIR "/usr/local/etc/dcmtk-3.6.7-DEV/"

/* Define to the default support data directory (used by some applications) */
#define DEFAULT_SUPPORT_DATA_DIR "/usr/local/share/dcmtk-3.6.7-DEV/"
